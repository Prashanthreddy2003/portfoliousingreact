                ...
                <section className="first">
                    ...
                    <section className="home" id="h">
                        ...
                        <div className="image" id="newdiv">
                            <img id="newimg" src="image.jpg" alt="my photo" />
                        </div>
                    </section>
                </section>
                <section className="second" id="a">
                    <div className="image2">
                        <img src="image1.jpg" alt="port" />
                    </div>
                    <div className="content2">
                        <h1 id="A">About me</h1>
                        <p>I am a dedicated and passionatnpm e web developer with a strong background in HTML, CSS, and JavaScript.
                ...
                <section className="Qua" id="q">
                    ...
                    <div className="qualification">
                        <div>
                            ...
                            <h2 className="clgname">sri chaitanya school</h2>
                            <h4>anantapuram</h4>
                        </div>
                        <div>
